#!/usr/bin/env python3
"""Dataset Generator - Practical categories for 90%+ accuracy"""
...
ALGORITHMS = ['AES', 'LegacyBlock', 'RSA', 'MD5', 'SHA1', 'SHA256', 'Base64', 'Hex', 'SHA512']
...
FUNCS = {
    'AES': encrypt_aes,
    'LegacyBlock': lambda p: random.choice([encrypt_des, encrypt_blowfish])(p),
    'RSA': encrypt_rsa,
    'MD5': hash_md5,
    'SHA1': hash_sha1,
    'SHA256': hash_sha256,
...
def main():
    ...
    parser.add_argument('-o', '--output', type=str, default='datasets/crypto_practical.csv')
