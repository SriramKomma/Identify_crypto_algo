#!/usr/bin/env python3
"""Dataset Generator - Grouping block ciphers for practical accuracy"""
...
ALGORITHMS = ['AES', 'DES', 'Blowfish', 'RSA', 'MD5', 'SHA1', 'SHA256', 'Base64', 'Hex', 'SHA512']
DEFAULT_SAMPLES_PER_ALGO = 4000
...
def hash_sha512(plaintext):
    ...
    return SHA512.new(plaintext).digest()
...
FUNCS = {
    ...
    'SHA256': hash_sha256, 'SHA512': hash_sha512, 'Base64': encode_base64, 'Hex': encode_hex
}
...
def main():
    ...
    parser.add_argument('-o', '--output', type=str, default='datasets/crypto_v2.csv')
